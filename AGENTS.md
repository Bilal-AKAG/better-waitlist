...
- **apps/web**: Fullstack TanStack Start + Vite app (port 3001)
...
- Database requires PostgreSQL; config in `apps/web/.env`
- Shared UI components imported as: `import { Button } from "@better-waitlist/ui/components/button"`
- Global styles in `packages/ui/src/styles/globals.css`
- Add shared components: `npx shadcn@latest add <component> -c packages/ui`

## Dependencies

- bun (v1.3.11) - Required package manager
- TypeScript, React 19, TailwindCSS v4
